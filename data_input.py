...
for image_file_name in image_file_names:
	...
	templateScaler = (yLines[9]-yLines[0])/157
	template = cv2.resize(template, (int(template.shape[1]*templateScaler), int(template.shape[0]*templateScaler)))
	...
	template = cv2.imread(template_filename, 0)
	templateScaler = (yLines[4]-yLines[0])/40
	template = cv2.resize(template, (int(template.shape[1]*templateScaler), int(template.shape[0]*templateScaler)))
	...
	# Open template
	template_directory = "Templates/"
	template_filename = os.path.join(template_directory, "rest_quarter.png")
	template = cv2.imread(template_filename, 0)
	...
	# Open template
	template_directory = "Templates/"
	template_filename = os.path.join(template_directory, "rest_eighth.png")
	template = cv2.imread(template_filename, 0)
	...
	# Open template
	template_directory = "Templates/"
	template_filename = os.path.join(template_directory, "rest_sixteenth.png")
	template = cv2.imread(template_filename, 0)
	...
	# Open template
	template_directory = "Templates/"
	template_filename = os.path.join(template_directory, "sharp.png")
	template = cv2.imread(template_filename, 0)
	...
	# Open template
	template_directory = "Templates/"
	template_filename = os.path.join(template_directory, "flat.png")
	template = cv2.imread(template_filename, 0)
	...
	# Open template
	template_directory = "Templates/"
	template_filename = os.path.join(template_directory, "note_eighth.png")
	template = cv2.imread(template_filename, 0)
	...
	for i in range(len(matches[0])):
		...
		# Save duration of this note for later
		noteBeats.append([int(x+8), int(y+4), 8])
